...
const basePath = "../";
let game1 = document.body?.className;
...
function initAbout() {
    console.log("About 初始化");
}
function initShowcase() {
    console.log("Showcase 初始化");
}
...
if (game1) {
    ...
    const tasks = [
        { name: "討伐史萊姆", count: 5, rewards: { coin: 500, exp: 200, items: ["藥水"] } },
        { name: "討伐哥布林", count: 5, rewards: { coin: 1000, exp: 800, items: ["中型回血藥水", "中型魔力藥水"] } },
        { name: "討伐骷髏兵", count: 5, rewards: { coin: 2000, exp: 5000, items: ["寶箱", "盾牌"] } },
        { name: "討伐野蠻人", count: 5, rewards: { coin: 5000, exp: 5000, items: ["寶箱", "盾牌"] } },
    ];
    ...
    const skillDatabase = {
        火球術: { name: "火球術", shop: true, rate: 30, price: 500, mpCost: 10, power: 30, desc: "對敵人造成自身攻擊力100%+30點火焰傷害並造成燃燒", type: "attack", effect: { target: "enemy", status: [{ type: "burn", value: 5, duration: 3, name: "燃燒" }] } },
        治癒術: { name: "治癒術", shop: true, rate: 30, price: 300, mpCost: 8, power: 25, desc: "恢復自身10%HP+25點固定值", type: "heal", effect: { target: "self", status: [{ type: "heal", value: 0 }] } },
        強化: { name: "強化", shop: true, rate: 30, price: 300, mpCost: 12, power: 0, desc: "提升自身攻擊力20%持續3回合", type: "buff", effect: { target: "self", buffs: [{ name: "攻擊力提升", type: "atk", value: 20, isPercent: true, duration: 3 }] } },
        弱化: { name: "弱化", shop: true, rate: 30, price: 300, mpCost: 12, power: 0, desc: "降低敵人攻擊力20%持續3回合", type: "debuff", effect: { target: "enemy", buffs: [{ name: "攻擊力下降", type: "atk", value: -20, isPercent: true, duration: 3 }] } },
        冰凍術: { name: "冰凍術", shop: true, rate: 30, price: 300, mpCost: 12, power: 30, desc: "造成攻擊力100%+30點冰霜傷害並冰凍敵人1回合", type: "control", effect: { target: "enemy", status: [{ type: "frozen", value: 0, duration: 1, name: "冰凍", successRate: 50 }] } },
        再生術: { name: "再生術", shop: true, rate: 25, price: 350, mpCost: 10, power: 0, desc: "每回合回復5%HP持續4回合", type: "buff", effect: { target: "self", buffs: [{ name: "再生", type: "regen", value: 5, isPercent: true, duration: 4 }] } },
        灼燒術: { name: "灼燒術", shop: true, rate: 35, price: 400, mpCost: 14, power: 40, desc: "造成自身攻擊力100%+40點火焰傷害並使敵人燃燒(3回合)", type: "attack", effect: { target: "enemy", status: [{ type: "burn", value: 6, duration: 3, name: "灼燒" }] } },
        毒霧術: { name: "毒霧術", shop: true, rate: 25, price: 350, mpCost: 15, power: 20, desc: "對敵人造成攻擊力100%+20點毒性傷害並中毒(3回合)", type: "attack", effect: { target: "enemy", status: [{ type: "poison", value: 5, duration: 3, name: "中毒" }] } },
        石化術: { name: "石化術", shop: true, rate: 20, price: 400, mpCost: 20, power: 25, desc: "造成少量傷害並使敵人石化(無法行動1回合)", type: "control", effect: { target: "enemy", status: [{ type: "stun", value: 0, duration: 1, name: "石化", successRate: 75 }] } },
        守護術: { name: "守護術", shop: true, rate: 30, price: 300, mpCost: 12, power: 0, desc: "提升自身防禦力25%持續3回合", type: "buff", effect: { target: "self", buffs: [{ name: "防禦力提升", type: "def", value: 25, isPercent: true, duration: 3 }] } },
        削甲: { name: "削甲", shop: true, rate: 25, price: 280, mpCost: 10, power: 10, desc: "攻擊敵人並降低其防禦力20%持續3回合", type: "attack", effect: { target: "enemy", buffs: [{ name: "防禦力下降", type: "def", value: -20, isPercent: true, duration: 3 }] } },
        怒擊: { name: "怒擊", shop: true, rate: 30, price: 350, mpCost: 10, power: 50, desc: "全力一擊造成自身攻擊力150%的物理傷害", type: "attack", effect: { target: "enemy", status: [{ type: "physical", value: 0 }] } },
        神聖光: { name: "神聖光", shop: true, rate: 20, price: 400, mpCost: 18, power: 30, desc: "恢復自身15%HP並解除不良狀態", type: "heal", effect: { target: "self", status: [{ type: "cleanse", value: 0 }] } }
    };
    ...
    const itemDatabase = {
        ...
        金鐘罩: { rate: 20, shop: false, price: 5000, name: "金鐘罩", type: "armor", def: 1000, quantity: 1, content: "+1000防禦力" },
    ...
    <html>
        ...
        <body style="font-family:sans-serif; text-align:center; background:#fffaf0; min-height:100vh;">
            <div class="container py-5">
                ...
                <button class="btn btn-warning mb-3" onclick="parent.drawTalent()">抽一個天賦</button>
...
function test11() {
    const images = ['小丑1.png', '小丑2.png', '烏一一阿一.png'];
    let index = 0;
...
function test10() {
    ...
    function border(value) {
        table.style.border = value + "px solid black";
    }
